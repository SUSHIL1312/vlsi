/* THIS FILE CONTAINS THE C-CODE FOR HARDWARE BLOCKS. AS THERE WERE SOME ISSUES IN PUTTING 
...
inline uint5_t get_bank( int addr )
{
  return bank_mapping[addr];
}

inline uint5_t get_offset( int addr )
{
  return offset_mapping[addr];
}

inline int get_data0 (int offset, int aa[ROWS*COLS])
{
	int a;
  switch (offset)
  {
...
inline int get_data1 ( int offset, int aa[ROWS*COLS])
{
	int a;
      switch (offset)
      {
...
inline int get_data2 ( int offset, int aa[ROWS*COLS])
{
	int a;
  switch (offset)
  {
...
inline int get_data3 ( int offset, int aa[ROWS*COLS])
{
	int a;
    switch (offset)
    {
...
inline int get_data4 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data5 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data6 ( int offset, int aa[ROWS*COLS])
{
	int a;
    switch (offset)
    {
...
inline int get_data7 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data8 ( int offset, int aa[ROWS*COLS])
{
	int  a;
...
inline int get_data9 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data10 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data11 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data12 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data13 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data14 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data15 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data16 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data17 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data18 ( int offset, int aa[ROWS*COLS])
{
	int a;
    switch (offset)
    {
...
inline int get_data19 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data20 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data21 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data22 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data23 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data24 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data25 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data26 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline int get_data27 ( int offset, int aa[ROWS*COLS])
{
	int a;
...
inline void get_all_data( int output[12], int addr_list[12], int aa[ROWS*COLS])
{
...
#pragma HLS loop_tripcount min=100 max=2000
    #pragma HLS unroll
    //output[i] = enable_list[i] ? data_from_banks[bank[i]]  : int("0",10);
    output[i] = data_from_banks[bank[i]];
  }

}

int use_data(int values[12], bit enable_list[12])
{
...
#pragma HLS DATAFLOW
  ...
  /** Square Integral Image Window buffer ( 4 registers )*/
...
#pragma HLS DATAFLOW
  ...
  int _II[WINDOW_SIZE*WINDOW_SIZE];
...
/*  if ( value > 65536 && value <  16777215 ){
    x = value >> 8;  // upper 18 bits
    y = value & 0x000000ff;
    sqrt = sqrts[x] << 4;
  }
  else{*/
